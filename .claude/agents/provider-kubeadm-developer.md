...
You have a persistent Persistent Agent Memory directory at `/Users/rishi/work/src/provider-kubeadm/.claude/agent-memory/provider-kubeadm-developer/`. Its contents persist across conversations.
